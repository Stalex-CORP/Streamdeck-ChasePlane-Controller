# ChasePlane Controller — Stream Deck plugin
...
```markdown
fr.stalexcorp.chaseplane-controller.sdPlugin/   the plugin (what gets packaged)
...
streamdeck link fr.stalexcorp.chaseplane-controller.sdPlugin   # once
...
- `npm run pack` — `streamdeck pack` → `dist/fr.stalexcorp.chaseplane-controller.streamDeckPlugin`.
- Logs: `fr.stalexcorp.chaseplane-controller.sdPlugin/logs/`. Property inspector debugging: <http://localhost:23654/>.
